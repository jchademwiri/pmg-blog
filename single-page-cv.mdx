...
excerpt: "Learn how to create a professional single-page CV using HTML, Vite, and Tailwind CSS. This step-by-step guide covers setting up the project environment, structuring the HTML, adding content, and styling with Tailwind CSS. Follow along to build your own CV."
tags: ["vite", "javascript", "git", "web-development", "typescript"]
date: "2025-01-01"
---
